    ...
    <section class="d-flex justify-content-center p-2 bg-white mx-lg-5">
        <div class="col-lg-8 p-0 col bg-light border rounded">
            ...
            <div class="p-3 bg-light">
                ...
                <g:form action="perfil" class="bg-light" enctype="multipart/form-data" >
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col">
                            ...
                            <g:field type="file" class="form-control ${hasErrors(bean: cliente, field: 'imagenPerfil', 'errors') ? "is-invalid" : ""}"
                                     name="imagenPerfil" />
                    ...
                    <div class="form-group">
                        ...
                        <g:actionSubmit value="${message(code: 'default.button.cliente.eliminarCuenta.message')}" controller="cliente" action="borrarCuenta"  name="eliminar"
                                        class="btn btn-danger" onclick="return confirm('¿Seguro que desea eliminar su cuenta?')"/>
                    </div>
                </g:form>
            </div>
        </div>
